...
namespace AZTU_Akademik.Controllers
{
    ...
    public class CandidateOfScienceController : Controller
    {
        ...
        [HttpGet("GetAll")]
        public JsonResult GetAll() => Json(aztuAkademik.ElmlerNamizedlikSiyahi.Include(x => x.TehsilSeviyye));

        [HttpGet("Get")]
        public JsonResult Get(int id) => Json(aztuAkademik.TehsilSeviyye.Where(x => x.ArasdirmaciId == id && x.ElmlerNamizediId > 0));
